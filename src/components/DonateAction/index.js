            ...
            <div style={{ maxHeight: '500px', height: '500px' }} className="w-3/4 m-auto flex ">
                <div className="w-full h-full relative ">
                    ...
                    <div
                        ...
                        className="absolute text-white flex flex-col w-full md:translate-x-1/10 md:translate-y-1/10 md:w-1/2 md:py-20 py-8 px-10 md:bottom-0 md:right-0 md:px-20"
                    >
